...
const logout = () => {
    ...
    localStorage.removeItem('cart-item', true)
...
<template>
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home' }" class="btn btn-ghost text-2xl font-bold">E-Commerce</RouterLink>
            </div>
            <div class="flex-none">
                <div class="form-control">
                    ...
                    type="text" 
                    placeholder="Search" 
                    class="input input-bordered mr-2 w-24 md:w-auto" 
                    v-model="searchText"
                    @keyup="handleSearch" />
                </div>
